...
_DEFAULT_CAMERA_URL = "rtsp://admin:asertan12@192.168.0.120:5554/cam/realmonitor?channel=1&subtype=0"
...
class ParkingConfig:
    ...
    # Camera — overridable via CAMERA_URL env var for deployment
    CAMERA_URL = os.getenv("CAMERA_URL", _DEFAULT_CAMERA_URL)
